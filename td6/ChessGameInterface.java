...
public class ChessGameInterface {
	...
	*/
	public static String getValueFromKeyJSON(String json, String jsonkey) {
		...
		return completeJson.getString(jsonkey);
	}

	public static void jsonArrayParser(JSONArray jsonArray) {
	...
	public static void jsonParser(JSONObject jsonObject) {
		for (String key : jsonObject.keySet()) {
			...
			if (value instanceof String)
				System.out.println("La valeur associée à la clé " + key + " est le String: " + value);
			if (value instanceof JSONArray) {
				jsonArrayParser((JSONArray) value);
			}
		}
	}
